 ...
 * @author Z420
 */
public class InvitacionesController implements Controller{

    @Override
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView mv = new ModelAndView("logged/invitaciones"); 
        try{
            ...
            if(user != null){
                System.out.println("[ INFO ] InvitacionesController.java Cargado");
