 ...
 * @author Z420
 */
public class CrearController implements Controller{

    @Override
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ModelAndView mv = new ModelAndView("logged/crearintercambios"); 
        try{
            ...
            if(user != null){
                System.out.println("[ INFO ] CrearController.java Cargado");
