<%-- 
    Document   : buscar
    Created on : 12-nov-2018, 13:35:48
    Author     : Sir-M
--%>
    ...
    <body style="background-color: #73A6B9">
        <nav class="navbar navbar-inverse">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="buscar.htm">Buscar Intercambio</a></li>
            </ul>
          </div>
        </nav>

        <div class="container" align="center">
          <h1 class="Navidad">BUSCAR</h1>
          ...
          <form id="FormRegistro" class="form-horizontal">
            <div class="form-group" style="padding-left: 200px;">
              <label class="control-label col-sm-2" for="email">Ingrese la ID del intercambio:</label>
              <div class="col-sm-6">
            ...
            <div class="form-group" style="padding-left: 200px;"> 
              <div class="col-sm-offset-2 col-sm-6">
                  <input type="button" class="btn btn-success btn-lg" onclick="buscar()" value="Buscar">
              </div>
            </div>
        ...
        <script type="text/javascript">
                        ...
                        success:  function (response) {
                          switch(response.registro){
                            case "ok":
                                ...
                                $("#alerta-mensaje").html("ID existente");
                            ...
                            case "fail":
                                ...
                                $("#alerta-mensaje").html("Lo siento, no existe este intercambio");
                              break;
                          }
                        }
                });
          ...
          function redireccionarPagina() {
            window.location = 'statusIntercambio.htm?id='+ID;
          } 
